...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \begin{equation*}
                (2,X) = \{2p(X)+Xq(X)\mid p(X),q(X)\in\Z[X]\}
            \end{equation*}
        ...
        \end{itemize}
        \item $M=\{f\mid f(1/2)=0\}=\ker(\ev_{1/2})\subset \R^{[0,1]}$ is a principal ideal.
        \begin{itemize}
        ...
        \end{itemize}
        \item The augmentation ideal is generated by $\{g-1\mid g\in G\}$.
        \begin{itemize}
