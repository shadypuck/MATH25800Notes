...
\begin{itemize}
    ...
    \item \marginnote{2/28:}Corollaries \ref{cly:10.18}-\ref{cly:10.19} in the special case of vector spaces.
    ...
    \begin{itemize}
        ...
        \begin{align*}
            \varphi(av_1+bv_2+cv_3) &= cv_1+2av_2-3bv_3&
            \psi(aw_1+bw_2) &= (a+3b)w_1+(4b-2a)w_2
        \end{align*}
        \begin{itemize}
        ...
        \end{equation*}
    \end{itemize}
    \item \marginnote{2/20:}\textbf{Idempotent} (linear transformation): A linear transformation $\psi$ satisfying $\psi^2=\psi$.
    \begin{itemize}
